...
import 'package:geniouscart/Providers/TicketPageProvider.dart';
...
class _TicketPageState extends State<TicketPage> {
  ...
  TicketPageProvider provider;

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<TicketPageProvider>(
      create: (_)=>TicketPageProvider()..setView(context),
      child: Consumer<TicketPageProvider>(
  ...
  Widget MessageView(TicketData data) {
      return ListView.builder(
          ...
          itemBuilder: (context,i){
            bool isMind=data.messages[i].userId==user.id.toString();
            return Container(
