...
class ImageFromNetwork extends StatefulWidget {
  ...
  double height;
  Color color;
  ImageFromNetwork({this.url,this.placeholder='assets/images/add-image.png',@required this.height,this.color});
...
class _ImageFromNetworkState extends State<ImageFromNetwork> {
  ...
  void initState() {
    super.initState();
    placeholder = widget.color!=null ? Image.asset(widget.placeholder,color: widget.color,) : Image.asset(widget.placeholder);
